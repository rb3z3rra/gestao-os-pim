...
import { ApontamentoOs, OrdemServico, StatusOs } from '@features/ordens-servico/models/ordem-servico.model';
...
import { OsSummaryCard } from '@features/ordens-servico/components/os-details/os-summary-card';
import { OsWorklogsCard } from '@features/ordens-servico/components/os-details/os-worklogs-card';
import { OsHistoryCard } from '@features/ordens-servico/components/os-details/os-history-card';
import { OsWorkflowActions } from '@features/ordens-servico/components/os-details/os-workflow-actions';
